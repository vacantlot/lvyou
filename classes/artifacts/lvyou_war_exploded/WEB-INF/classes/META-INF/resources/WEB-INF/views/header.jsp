...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index" class="navbar-brand">基于Java Web的旅游网站</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>index"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;首页</a></li>
                        <li><a href="<%=basePath %>index"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;发布信息</a></li>
                        <li><a href="<%=basePath %>index"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我发布的信息</a></li>
                        <li><a href="<%=basePath %>index"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;修改个人资料</a></li>
                        <li><a href="<%=basePath %>index"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我的收藏</a></li>
                    </ul>
                </li>
      ...
      <div class="modal-body">
      	<form class="form-horizontal" name="registerForm" id="registerForm" enctype="multipart/form-data" method="post"  class="mar_t15">
            <div class="form-group">
                <label for="userName" class="col-md-3 text-right">用户名:</label>
                <div class="col-md-9">
                    <input type="text" id="RegiuserName" name="userName" class="form-control" placeholder="请输入用户名">
                </div>
            </div>
            ...
            <div class="form-group">
                <label for="password" class="col-md-3 text-right">密码:</label>
                <div class="col-md-9">
                    <input type="password" id="Regipassword" name="password" class="form-control" placeholder="登录密码">
                </div>
            </div>
...
function ajaxRegister() {
    jQuery.ajax({
        ...
        dataType: "json",
        data: {
            "name": $('#RegiuserName').val(),
            "password": $('#Regipassword').val(),
        },
        success: function (obj) {
            if (obj.head.code == "200") {
                alert("注册成功！");
