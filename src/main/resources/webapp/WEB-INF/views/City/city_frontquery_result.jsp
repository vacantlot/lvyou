				    				...
				    				<table class="table table-condensed table-hover">
				    					...
				    					<% 
 										...
 										<tr>
 											...
 											<td>
 												<a href="<%=basePath  %>City/<%=city.getCityId() %>/frontshow"><i class="fa fa-info"></i>&nbsp;查看</a>&nbsp;
 												<a href="#" onclick="cityEdit('<%=city.getCityId() %>');" style="display:none;"><i class="fa fa-pencil fa-fw"></i>编辑</a>&nbsp;
 												<a href="#" onclick="cityDelete('<%=city.getCityId() %>');" style="display:none;"><i class="fa fa-trash-o fa-fw"></i>删除</a>
 											</td> 
 										</tr>
 										<%}%>
				    				</table>
